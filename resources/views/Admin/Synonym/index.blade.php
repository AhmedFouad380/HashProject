                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <h5 class="text-dark font-weight-bold my-1 mr-5 ">{{trans('lang.Synonym')}}</h5>
                            </li>
                        </ul>
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">{{__('lang.Synonym')}}
                    </div>
            ...
            <span class="svg-icon svg-icon-md">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <!--end::Svg Icon-->
            </span> {{__('lang.Synonym_create')}}</button>
                        &nbsp;&nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-success btn-sm btn-clean btn-icon btn-icon-md edit-Advert"
                                       data-id="{{$User->id}}" data-original-title="{{__('lang.Synonym_Edit')}}"
                                       title="{{__('lang.Synonym_Edit')}}">
                        ...
                        <div class="col-xl-12">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <input class="form-control form-control-solid" type="number" name="phone"
                                               value="">
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="kt_modal_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        {{__('lang.Synonym_Create')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                    <form class="px-10" novalidate="novalidate" id="kt_form" method="post"
                          action="{{url('Create_Synonym')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>{{__('lang.word')}} </label>
                            <input type="text" class="form-control form-control-solid" name="word" required
                                   placeholder="{{__('lang.word')}}">
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content card card-outline-info">
                <div class="modal-header card-header">
                    <h3 class="modal-title" id="myLargeModalLabel">{{__('lang.Synonym_Edit')}}</h3>
