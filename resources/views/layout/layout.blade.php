...
@if(session('lang') == 'en')
    ...
    @else
        ...
        <head>
            ...
            <meta charset="utf-8"/>
            <title>
                {{\App\Models\Setting::find(1)->name}}
                | @yield('title')
            </title>
                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    ...
                    <div class="brand flex-column-auto" id="kt_brand">
                        ...
                        <a href="{{url('/')}}" class="brand-logo">
                            <img alt="Logo" src=" {{\App\Models\Setting::find(1)->logo}}" style="width:150px;"/>
                        </a>
                        <!--end::Logo-->
                        <!--begin::Toggle-->
                    ...
                    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        ...
                        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                            ...
                            <ul class="menu-nav">
                                ...
                                @if(Request::segment(1) == 'Admins' || Request::segment(1) == 'Users' || Request::segment(1) == 'Synonym' || Request::segment(1) == 'suppliers' ||
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                                                    ...
                                                    <li class="menu-item @if(Request::segment(1) == 'Synonym')  menu-item-active @endif  "
                                                            aria-haspopup="true">
                                                            <a href="/Synonym" class="menu-link">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <span   class="text-dark-75 text-hover-primary">
                                {{\App\Models\Setting::find(1)->footer_description}}
                            </span>
